...
namespace DotLiquid
{
	public static class Liquid
	{
		...
		public static readonly string PartialTemplateParser = string.Format(R.S(@"{0}.*?{1}|{2}.*?{3}"), TagStart, TagEnd, VariableStart, VariableIncompleteEnd);
		public static readonly string TemplateParser = string.Format(R.S(@"({0}|{1})"), PartialTemplateParser, AnyStartingTag);
